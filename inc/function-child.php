...
function velocitychild_theme_setup()
{
    ...
    if (class_exists('Kirki')) :
        ...
        Kirki::add_field('justg_config', [
            'type'        => 'color',
            'settings'    => 'color_second',
            'label'       => __('Theme Second Color', 'kirki'),
            'description' => esc_html__('', 'kirki'),
            'section'     => 'section_colorvelocity',
            'default'     => '#803500',
            'transport'   => 'auto',
...
if (!function_exists('justg_widgets_init')) {
    function justg_widgets_init()
    {
        ...
        $before_title = '<h3 class="widget-title position-relative"><span class="vd-title">';
        $after_title = '</span></h3><div class="widget-styles">';
        register_sidebar(
            array(
